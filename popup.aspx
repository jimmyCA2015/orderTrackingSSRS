...
<body>
    ...
    <div>
       <asp:Label Text="Search By Ship To Number"  runat ="server" style="position:absolute; top: 21px; left: 23px;"></asp:Label>
        
        <asp:TextBox ID="ShipNo"     runat ="server" style="position:absolute; top: 21px; left: 210px;"></asp:TextBox>
        <asp:Label ID="Label1" Text="Delivery Location Search" runat ="server" style="position:absolute; top: 21px; left: 400px;font-weight:bold;font-size:large"></asp:Label>
        ...
        <asp:Label Text="OR" runat="server"  style="position:absolute; top: 51px; left: 23px;"></asp:Label>
         <asp:Label Text="Search By Hospital Name"  runat ="server" style="position:absolute; top: 81px; left: 23px;"></asp:Label>
        <asp:TextBox ID="SoldNum"     runat ="server" style="position:absolute; top: 81px; left: 210px;"></asp:TextBox>
    </div>
    <asp:Button Text="Search"  style="position:absolute; top: 81px; left: 400px;" runat="server" OnClientClick="clearText()"  OnClick="Unnamed2_Click" CausesValidation="true"></asp:Button>
