...
public partial class popup2 : System.Web.UI.Page
{
    public DataView currentlist;
    protected void Page_Load(object sender, EventArgs e)
    {
        Session["hospitalname2"] = "";
        Session["address2"] = "";
        Session["shipno2"] = "";
    }
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        {
            Session["hospitalname2"] = ds.Tables[0].Rows[0]["HOSPITAL NAME"];
            currentPickup.getDeliveryTo2 = (String)Session["hospitalname2"];
        }
        if (ds.Tables[0].Rows.Count != 0)
        {
            Session["address2"] = ds.Tables[0].Rows[0]["ADDRESS 1 "] + " - " + ds.Tables[0].Rows[0]["ADDRESS 2"] + "  " + ds.Tables[0].Rows[0]["CITY NAME"] + "  " + ds.Tables[0].Rows[0]["PROVINCE"] + "  " + ds.Tables[0].Rows[0]["POSTAL CODE"];
            currentPickup.getDeliveryLocation2 = (String)Session["address2"];
        }
        if (ds.Tables[0].Rows.Count != 0)
        {
            Session["shipno2"] = ds.Tables[0].Rows[0]["SHIP TO"];
            currentPickup.getShipToNumber2 = Session["shipno2"].ToString();
        }
    }
    ...
    protected void GridView1_SelectedIndexChanging(Object sender, GridViewSelectEventArgs e)
    {
        ...
        // is displayed.
        Session["hospitalname2"] = row.Cells[2].Text.Replace("&amp;", "&").Replace("&nbsp;", " ").Replace("&#39;", "'");
        Session["address2"] = row.Cells[4].Text.Replace("&amp;", "&").Replace("&nbsp;", " ").Replace("&#39;", "'") + " - " + row.Cells[5].Text.Replace("&amp;", "&").Replace("&nbsp;", " ").Replace("&#39;", "'") + "  " + row.Cells[6].Text.Replace("&amp;", "&").Replace("&nbsp;", " ").Replace("&#39;", "'") + "  " + row.Cells[7].Text.Replace("&amp;", "&").Replace("&nbsp;", " ").Replace("&#39;", "'") + "  " + row.Cells[8].Text.Replace("&amp;", "&").Replace("&nbsp;", " ").Replace("&#39;", "'");
        Session["shipno2"] = row.Cells[1].Text;
        currentPickup.getDeliveryLocation2 = (String)Session["address2"];
        currentPickup.getDeliveryTo2 = (String)Session["hospitalname2"];
        currentPickup.getShipToNumber2 = Session["shipno2"].ToString();
    }
